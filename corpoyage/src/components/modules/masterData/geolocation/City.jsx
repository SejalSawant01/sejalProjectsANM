...
const City = () => {
  ...
  return (
    <>
      {location.pathname === "/master-data/geolocation/city" ? (
        <MasterPage
          title="City"
          fields={productMaster}
          btn1={{ text: "Search", route: "/master-data/geolocation/city" }}
          btn2={{ text: "New", route: "/master-data/geolocation/city/new-city" }}
          url="comstate/search"
          deleteurl="comstate/delete"
          save={false}
          editbtn1={{ text: "Edit", edit: "UPDATE", route: "/master-data/geolocation/city" }}
          editbtn2={{ text: "CANCEL", edit: "EDIT", route: "/master-data/geolocation/city" }}
