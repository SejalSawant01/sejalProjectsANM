...
const NewOrgnizationStaffRegistration = () => {
    const productMaster = [
        {
     ...
     return (
      ...
      <MasterPage
        ...
        btn1={{ text: "Save", route: "/admin-management/orgnization-master/organization-staff-registration/new-organization-staff-registration" }}
        btn2={{ text: "Cancel", route: "/admin-management/orgnization-master/organization-staff-registration" }}
        url="addStateDef"
        save={true}
...
export default NewOrgnizationStaffRegistration