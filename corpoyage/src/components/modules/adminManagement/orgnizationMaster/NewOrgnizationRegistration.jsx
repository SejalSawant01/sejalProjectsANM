...
const NewOrgnizationRegistration = () => {
    const productMaster = [
        {
     ...
     return (
      ...
      <MasterPage
        ...
        btn1={{ text: "Save", route: "/admin-management/orgnization-master/organization-registration/new-organization-registration" }}
        btn2={{ text: "Cancel", route: "/admin-management/orgnization-master/organization-registration" }}
        url="addStateDef"
        save={true}
...
export default NewOrgnizationRegistration