...
const OrgnizationStaffRegistration = () => {
    ...
    return (
      <>
        {location.pathname === "/admin-management/orgnization-master/organization-staff-registration" ? (
          <MasterPage
            title="Organization Staff Registration"
            fields={productMaster}
            btn1={{ text: "Search", route: "/admin-management/orgnization-master/organization-staff-registration" }}
            btn2={{ text: "New", route: "/admin-management/orgnization-master/organization-staff-registration/new-organization-staff-registration" }}
            url="comstate/search"
            deleteurl="comstate/delete"
            save={false}
            editbtn1={{ text: "Edit", edit: "UPDATE", route: "/admin-management/orgnization-master/organization-staff-registration" }}
            editbtn2={{ text: "CANCEL", edit: "EDIT", route: "/admin-management/orgnization-master/organization-staff-registration" }}
...
export default OrgnizationStaffRegistration